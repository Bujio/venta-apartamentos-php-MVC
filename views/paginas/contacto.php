<main class="contenedor seccion">
    ...
    <form class="formulario" method="POST" action="/contacto">
        <fieldset>
            ...
            <input type="email" placeholder="correo@correo.com" id="nombre" name="contacto[email]" required>
            <label for="nombre">Teléfono</label>
            <input type="tel" placeholder="teléfono de contacto" id="nombre" name="contacto[telefono]" required>

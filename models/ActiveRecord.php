...
class ActiveRecord
{
  ...
  //BASE DE DATOS
  //static xk si creamos 1000 objetos todos requieren la misma conexion
  //ARREGLO PERMITE IDENTIFICAR QUE FORMA TIENE LOS DATOS PARA MAPEAR EL OBJT Y UNIRLOS
  protected static $db;
